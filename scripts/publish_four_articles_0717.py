...
articles_config = [
    {
        "src_name": "20260716AI時代的思維摩擦——孩子用AI，哪些嚼的功夫不能省-1",
    ...
    {
        "src_name": "20260716螞蟻死亡螺旋——看見的人為什麼也走不出來",
    ...
    {
        "src_name": "20260717你選的不是文法，是一條有上限的路",
    ...
    {
        "src_name": "20260717螞蟻死亡螺旋（二）——看見新路，為什麼不走上去-1",
...
def register_post(slug, title, kicker, categories, date, carousel_count):
    ...
    if f'slug: "{slug}"' not in posts_content:
        ...
        # Pick relevant related posts for linkage
        related_slugs = ["cognitive-friction-in-ai-era", "ant-death-spiral-p1", "not-grammar-but-limit", "ant-death-spiral-p2"]
        # Remove current slug from related
...
def main():
    ...
    commit_msg = f"feat: publish four articles (0716 & 0717) and deploy {deploy_version}"
