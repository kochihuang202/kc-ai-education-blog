...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    article p.latest-change {{ position:relative; }}
    article p.latest-change::before {{ content:""; position:absolute; left:-22px; top:0; bottom:0; width:7px; background:radial-gradient(circle, #df8b3f 0 3.5px, transparent 3.8px) center top / 7px 1.95em repeat-y; }}
